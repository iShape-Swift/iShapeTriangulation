//
//  MotonePlainTriangulationScene.swift
//  iShapeUI
//
...
final class MotonePlainTriangulationScene: CoordinateSystemScene {
    
    private var pageIndex: Int = 7
...
extension MotonePlainTriangulationScene: MouseCompatible {
